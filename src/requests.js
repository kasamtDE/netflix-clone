...
export const fetchUrl = {
    ...
    fetchScienceFictionMovies:`https://api.themoviedb.org/3/discover/movie?api_key=${api_KEY}&language=en-US&sort_by=popularity.desc&include_adult=false&page=1&with_genres=878`,
